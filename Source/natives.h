...
namespace FIRE
{
	...
	static void ADD_EXPLOSION(float x, float y, float z, int explosionType, float damageScale, BOOL isAudible, BOOL isInvisible, float cameraShake, bool noDamage) { Hooking::explosionbypass(true); invoke<Void>(0xE3AD2BDBAEE269AC, x, y, z, explosionType, damageScale, isAudible, isInvisible, cameraShake, noDamage);  Hooking::explosionbypass(false); } // 0xE3AD2BDBAEE269AC 0x10AF5258
