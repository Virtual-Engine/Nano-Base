...
enum SubMenus { //Add Sub Menus in here pretty 
	NOMENU,
	mainmenu,
	sub,
	settings,
...
namespace Menu {
	...
	namespace Settings {
		...
		extern float TickBoxLevel;
		extern float TickBoxThicnessLevel;
		extern float TickBoxLevel2;
		extern float TickBoxHeightLevel; 


		extern float SubtitleXPos;
		extern float SubtitleYPos;
		extern float HeaderXPos;
		extern float HeaderYPos;
		extern float TextPosX;
		extern float TextPosY;
		extern float RectThicness;
		extern float Rectwideness;
		extern float TextWidness;
		extern float TextThicness;

		extern float ArrowPosX;//Sure why not 
		extern float ArrowPosY;
		extern float ArrowWidness;
		extern float ArrowThicness;
		//
		extern float menuX;
		extern RGBAF count;
		extern RGBAF SubtitleText;
		extern RGBA SubtitleRect;
